...
def main():
    ...
    ns = "http://mcc.lip6.fr/"
    command_sym = 'pnml2lts-sym model.pnml --lace-workers=4 --vset=lddmc --order=chain-prev --next-union --sat-granularity=5 --saturation=sat-like -r%s --sylvan-sizes=28,28,28,28 %s' % (args.reorder, args.extraopts)
